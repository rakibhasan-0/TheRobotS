 ...
 * and y-axis should be consider as the x-axis.
...
public class RightHandRuleRobot implements Robot{
    ...
    private void setPosition (Position pos){
        ...
        position = pos;
        if(getDirection() == 0){
            labyrint[position.getY()][position.getX()] = 'n';
        }
        if(getDirection() == 1){
            labyrint[position.getY()][position.getX()] = 'w';
        }
        if(getDirection() == 2){
            labyrint[position.getY()][position.getX()] = 's';
        }
        if(getDirection() == 3){
            labyrint[position.getY()][position.getX()]  = 'e';
        }
    }
